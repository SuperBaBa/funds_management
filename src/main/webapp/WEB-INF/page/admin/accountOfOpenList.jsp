...
<div data-options="region:'south'" style="height: 100%;">
	...
	<div id="tb" style="height:auto">
		...
		<!-- <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-ok',plain:true" onclick="using()">启用</a> -->
		<a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-cancel',plain:true" onclick="freeze()">冻结</a>
...
<div id="window" class="easyui-window" title="详细信息"
	...
	<table id="pg" style="width:auto"data-options="
				method:'post',
				scrollbarSize:0
			"></table>
</div>
